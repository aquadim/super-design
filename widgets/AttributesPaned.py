...
BINDING_PREFIX = "ATTRIBUTESPANED"

class OnActivateEventData:
...
def on_attribute_selected(view, pos, ev_data):
    ...
    ev_data.clear_bindings()
    b = ev_data.b
    ev_data.box.set_visible(True)
...
def get_attributes_paned(store_attribute, id_to_binding):
    ...
    ev_data = OnActivateEventData(b, box)
    ...
    lv.connect("activate", on_attribute_selected, ev_data)
